...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        AutoskolaInterface a = new AutoskolaLogic();
        boolean run = true;
        ...
        while (run) {
            ...
            try {
                ...
                System.out.println("Zde napiš svuj email");
                while(!a.chceckEmail(sc.next())){
                    System.out.println("Spatne zadana emailova adresa. Zkus to znovu");
                }
